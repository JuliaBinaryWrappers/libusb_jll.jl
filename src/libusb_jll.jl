...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libusb_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a877fdc9-fe69-5ed6-b93d-11ecd0dc2d49"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libusb", artifacts_toml) for e in artifacts["libusb"]]
...
if best_platform === nothing
    @debug("Unable to load libusb; unsupported platform $(triplet(platform_key_abi()))")
else
